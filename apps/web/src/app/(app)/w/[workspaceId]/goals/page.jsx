                ...
                >
                  ...
                  <div className="flex flex-col items-end gap-2 pt-1">
                    {(() => {
                      ...
                      const canEdit = !g._pending && (isOwner || isAdmin);
                      return (
                        <GoalStatusPicker
                          value={g.status}
                          size="sm"
                          ...
                          disabledReason={
                            g._pending
                              ? "Saving the goal — try again in a moment"
                              : canEdit
                              ? undefined
                          ...
                          onChange={async (next) => {
                            try {
                              await updateGoal(g.id, { status: next });
                              toast.success(
